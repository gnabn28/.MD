...
$badge = [
    'Đã giao'        => ['class' => 'badge-success', 'icon' => 'fa-circle-check',  'label' => 'Đã giao'],
    'Đang giao'      => ['class' => 'badge-info',    'icon' => 'fa-truck',          'label' => 'Đang giao'],
    'Chưa xác nhận'  => ['class' => 'badge-warning', 'icon' => 'fa-clock',          'label' => 'Chưa xác nhận'],
    'Đang xử lý'     => ['class' => 'badge-warning', 'icon' => 'fa-clock',          'label' => 'Đang xử lý'],
    'Đã hủy'         => ['class' => 'badge-danger',  'icon' => 'fa-circle-xmark',   'label' => 'Đã hủy'],
];
$defaultBadge = ['class' => 'badge-warning', 'icon' => 'fa-clock', 'label' => 'Chưa xác nhận'];
        ...
        <section class="content-section" id="section-orders" style="display:none;">
            ...
            <div class="stat-cards">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-value"><?= count(array_filter($orders, fn($o)=>in_array($o['TrangThai'],['Đang giao','Đang xử lý','Chưa xác nhận']))) ?></div>
