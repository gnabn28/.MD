...
<body>
    <form method="POST">
        ...
        <div style="display:flex; gap:10px; margin-bottom:15px;">
            <input type="text" name="otp" placeholder="Nhập mã xác thực" required style="margin-bottom:0; flex:1; color:#000; background:#fff;">
            <button type="button" onclick="alert('Mã xác thực tài khoản của bạn là: 8888\n(Mô phỏng gửi SMS/Email)')" style="background:#e2e8f0; color:#334155; border:none; padding:0 15px; border-radius:8px; font-weight:600; cursor:pointer; white-space:nowrap;">Gửi mã</button>
        </div>
